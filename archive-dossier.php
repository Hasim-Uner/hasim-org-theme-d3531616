 ...
 * @version 5.5.3 — Wissensplattform Phase 3
 */
...
<main id="main-content" class="hp-dossier-archive">
    <div class="hp-dossier-archive__inner">
        ...
        <?php if ( $hp_dossier_query->have_posts() ) : ?>

            <div class="hp-dossier-grid">
        ...
        <?php else : ?>
            <div class="hp-dossier-grid hp-dossier-grid--empty">
