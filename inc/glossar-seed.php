...
function hp_get_sterblichkeit_essay_content(): string {
	...
	$sections = [
		...
		'II. Der Kategorienfehler: Wenn der Geist das Fleisch verlässt' => [
			...
			'<p>Mit dem Geist geschieht dabei dasselbe wie mit dem Körper. So wie der Leib zur Hardware wird, schrumpft die Intelligenz zur Rechenleistung — zu etwas, das sich in Operationen pro Sekunde messen lässt. In dieser Optik gilt: je schneller, desto klüger. Doch Geschwindigkeit ist keine Intelligenz, sondern eine andere Größe. Ein Taschenrechner schlägt jeden Menschen millionenfach im Multiplizieren, und niemand käme auf die Idee, ihn weise zu nennen. Dass Maschinen in eng umrissenen Feldern längst Übermenschliches leisten — Proteinfaltungen vorhersagen, an denen die Biochemie jahrzehntelang scheiterte —, widerlegt diesen Einwand nicht, sondern schärft ihn. Ein System kann in einer Dimension überlegen sein und dennoch nicht wissen, welche Frage zu stellen wäre und warum sie zählt. Es löst die Probleme, die man ihm gibt; es erkennt nicht, welche Probleme zu lösen sind. Wenn das Silicon Valley solche Systeme „intelligenter als den Menschen" nennt, hat es Intelligenz zuvor auf das verengt, worin Maschinen stark sind: aufs Rechnen. Der Mensch verliert dann einen Wettkampf, dessen Regeln eigens so geschrieben wurden, dass nur die Maschine ihn gewinnen kann.</p>',
			'<p>Dagegen steht ein gut belegter Einwand. Die Phänomenologie des Leibes, wie sie Maurice Merleau-Ponty entwickelt hat, zeigt: Der Mensch <em>hat</em> seinen Körper nicht, er <em>ist</em> sein Körper. Wahrnehmung, Absicht, Orientierung sind keine Rechenleistung, die im Schädel stattfindet — sie sind leiblich. Ich bin kein Pilot in einem Fahrzeug. Das Selbst entsteht im Vollzug: in der Bewegung, im Tasten, im Stoffwechsel, im Zusammenspiel von Hormonen, im Mikrobiom des Darms, in der ständigen, größtenteils unbewussten Rückkopplung zwischen Körper und Umwelt. Die kognitionswissenschaftliche Forschung zur „verkörperten Kognition" hat diese Einsicht breit untermauert: Denken ist kein körperloser Prozess.</p>',
		...
		'V. Der Gegenentwurf: Sorge und Endlichkeit' => [
			'<p>Der Gegenentwurf denkt nicht kleiner von der Technik, sondern größer vom Menschen. Fortschritt bemisst sich dann nicht daran, wie weit wir uns von unserer biologischen Natur entfernen, sondern wie tief wir ihr gerecht werden. Drei Richtungen, konkret.</p>',
